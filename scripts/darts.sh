...
python -u process_stations/process_stations.py -stations dataset/brazil_stations.txt -filtering_model_index 1 -scorer_index 0
python -u process_stations/process_stations.py -stations dataset/brazil_stations.txt -filtering_model_index 1 -scorer_index 1
python -u process_stations/process_stations.py -stations dataset/brazil_stations.txt -filtering_model_index 1 -scorer_index 2
...
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 0 -scorer_index 2
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 1 -scorer_index 0
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 1 -scorer_index 1
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 1 -scorer_index 2
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 2 -scorer_index 0
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 2 -scorer_index 1
python -u process_stations/process_stations.py -stations dataset/ecuador_stations.txt -filtering_model_index 2 -scorer_index 2
